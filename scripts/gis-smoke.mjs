...
if (!portsmouth) throw new Error('TIGERweb search did not return Portsmouth, Virginia.');
...
console.log(`GIS smoke test passed: ${portsmouth.name} (${portsmouth.type}), ${boundary.geometry.type}, geography entitlement/mask valid, OpenFreeMap 3D source available.`);
